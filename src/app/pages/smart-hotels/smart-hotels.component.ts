...
@Component({
  ...
  template: `
    <!-- Hero Section -->
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-bg via-surface to-bg pt-16">
      <!-- Background Elements -->
      ...
      <div class="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        <h1 
          ...
          <span class="text-primary">{{ smartHotelsData?.hero?.title || 'Smart Hotels Suite' }}</span>
        </h1>
        ...
        <p 
          ...
          {{ smartHotelsData?.hero?.subtitle || 'Websites & Booking • PMS • Digital Keys • IoT • Analytics & More' }}
        </p>
            ...
            <div class="space-y-6">
              <div 
                *ngFor="let benefit of smartHotelsData?.forGuests" 
                class="flex items-start space-x-4">
                <div class="w-2 h-2 bg-accent rounded-full mt-3 flex-shrink-0"></div>
                <span class="text-white/80 text-lg">{{ benefit }}</span>
              </div>
            </div>
          </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          ...
          <p 
            ...
            Everything you need to transform your hotel into a smart, connected experience
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div 
            *ngFor="let feature of smartHotelsData?.features; let i = index"
            ...
            <div class="bg-black/20 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:border-primary/50 transition-all duration-300 hover:scale-105 h-full">
              <div class="w-16 h-16 bg-primary/20 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary/30 transition-colors duration-300">
                <i class="pi pi-star text-2xl text-primary"></i>
              </div>
              <h3 class="text-xl font-semibold text-white mb-4 group-hover:text-primary transition-colors duration-300">
                {{ feature.title }}
              </h3>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div 
            ...
            [speed]="0.2"
            class="device-mockup">
            <div class="bg-black/20 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center">
              <div class="w-32 h-64 bg-gradient-to-br from-primary/20 to-accent/20 rounded-3xl mx-auto mb-4 flex items-center justify-center">
          ...
          <div 
            ...
            class="device-mockup">
            <div class="bg-black/20 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center">
              <div class="w-48 h-32 bg-gradient-to-br from-accent/20 to-primary/20 rounded-2xl mx-auto mb-4 flex items-center justify-center">
                <i class="pi pi-tablet text-4xl text-accent"></i>
              </div>
              <h3 class="text-lg font-semibold text-white mb-2">Hotel Dashboard</h3>
              <p class="text-white/70 text-sm">Real-time operations & analytics</p>
            </div>
          </div>
          ...
          <div 
            ...
            class="device-mockup">
            <div class="bg-black/20 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center">
              <div class="w-32 h-32 bg-gradient-to-br from-primary/20 to-accent/20 rounded-full mx-auto mb-4 flex items-center justify-center">

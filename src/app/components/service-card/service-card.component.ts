...
@Component({
  ...
  template: `
    <div class="service-card h-full group">
      <div
        class="bg-black/30 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:border-primary/50 transition-all duration-500 hover:scale-105 h-full flex flex-col relative overflow-hidden"
      >
        <!-- Shimmer effect -->
        <div
        ...
        <!-- Icon -->
        <div
          class="w-20 h-20 bg-gradient-to-br from-primary/20 to-accent/20 rounded-3xl flex items-center justify-center mb-6 group-hover:bg-primary/30 transition-all duration-300 mx-auto group-hover:scale-110 icon-glow"
        >
          <i
        ...
        <div class="flex-1 relative z-10">
          <h3
            class="text-xl font-bold text-white mb-4 text-center group-hover:text-primary transition-colors duration-300"
          >
            {{ service.title }}
          </h3>
        ...
        <div class="mt-auto text-center relative z-10">
          <a
            ...
            class="inline-flex items-center text-primary hover:text-primary-light transition-all duration-300 group-hover:translate-x-1 font-semibold px-4 py-2 rounded-xl hover:bg-primary/10"
          >
            Learn more
            <i
